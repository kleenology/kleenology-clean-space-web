...
export const CATALOGUE = {
  ...
  groups: [
    ...
    },
    {
      ...
      kind: "addon",
      items: [
        { code: "KLN-057", label: "سجادة 3*3م", price: 108, time: "1-3 ساعة", note: "المتر بـ12 ريال" },
        { code: "KLN-058", label: "سجادة 4*4م", price: 192, time: "1-3 ساعة", note: "اكثر من عشرين متر المتر بـ10" },
        { code: "KLN-059", label: "سجادة 5*5م", price: 210, time: "1-3 ساعة" },
        // سعر ثابت للمتر لا يدخل في خصم العرض
